...
class Preprocess:
    ...
    def run(self, normalise, epochs):
        with open("feature importance.txt", "w") as f:
            data = self._read_data_spam("../data/spambase.data.txt")
            ...
            feature_alpha = boosting.boost(training_data,testing_data,  epochs, f)
            fraction = {}
