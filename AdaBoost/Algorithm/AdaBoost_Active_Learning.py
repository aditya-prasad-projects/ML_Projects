...
np.random.seed(0)
from AdaBoost.Weak_Classifiers.weak_classifier_decision_Stump import weak_classifier_decision_stump_2
...
class AdaBoost_Active_Learning:
    ...
    def boost(self, training_data, testing_data, epochs, f):
        ...
        for i in range(epochs):
            ...
            if(i % 100 == 0):
                f.write("\n" + str(i))
                f.write("training_accuracy = " + str(training_accuracy))
                f.write("testing_accuracy = " + str(testing_accuracy))
                print(i)
